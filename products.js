module.exports = function(){
    ...
    router.put('/:id', function(req, res){
        ...
        var sql = "UPDATE products SET product_type=?, product_name=?, distributor_ID=?, retail_price=?, release_date=?, quant_in_stock=? WHERE product_ID=?";
        var inserts = [req.body.product_type, req.body.product_name, req.body.distributor_ID, req.body.retail_price, req.body.release_date, req.body.quant_in_stock, req.params.id];
        sql = mysql.pool.query(sql,inserts,function(error, results, fields){
            if(error){
                console.log(error)
                res.write(JSON.stringify(error));
